...
object UseCaseModule {
    ...
    @Provides
    fun provideGetCriticalIngredients(ingredientsRepository: IIngredientsRepository): getCriticalIngredientsUseCase {
        return getCriticalIngredientsUseCase(ingredientsRepository)
    }
    //Client
    @Provides
